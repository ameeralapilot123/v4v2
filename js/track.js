...
var campaignID = "6a358668c8d75c154c252c9f";
...
var initialSrc = "https://ad.mustgraboffers.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("ad.mustgraboffers.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://ad.mustgraboffers.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://ad.mustgraboffers.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
